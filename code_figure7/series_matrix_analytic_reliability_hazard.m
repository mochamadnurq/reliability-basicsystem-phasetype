% Reliability & Hazard Function of Series System
...
ta = ta';
tb = tb';
save 'data_fig_series_Rs_Hs.mat';

%% OUTPUT: Table of Computing Time
disp('Computing Time of Series System with K Components')
...
text(t(4)+8,rs(4,1),'2 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(4)+8,rs(4,2),'4 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(4)+8,rs(4,3),'6 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(4)+8,rs(4,4),'8 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
...
axis([0 tmax 0 0.08]);
text(t(12),hs(12,1)-0.002,'2 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(12),hs(12,2)-0.002,'4 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(12),hs(12,3)-0.002,'6 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(12),hs(12,4)-0.002,'8 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);