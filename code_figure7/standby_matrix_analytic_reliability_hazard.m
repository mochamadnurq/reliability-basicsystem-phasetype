% Reliability & Hazard Function of Standby System Perfect Switch
...
for j = 1:length(K)
    ...
    tic
    Ts    = phaddsys(T(1:K(j)),ones(K(j),1));
    t1(j) = toc;
...
ta = ta';
tb = tb';
save 'data_fig_standby_Rs_Hs.mat';

%% OUTPUT: Table of Computing Time
disp('Computing Time of Standby System with K Components')
...
text(t(4)+40,rs(4,1),'2 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(6)+40,rs(6,2),'4 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(8)+40,rs(8,3),'6 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(10)+40,rs(10,4),'8 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
...
axis([0 tmax 0 0.01]);
text(t(12),hs(12,1)-0.0003,'2 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(12),hs(12,2)-0.0003,'4 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(12),hs(12,3)-0.0003,'6 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);
text(t(12),hs(12,4)-0.0003,'8 Components','FontName','Times New Roman','FontAngle','italic','FontSize',14);